...
def caret2networkx(filename: str, target_path: str = 'all_graph') -> nx.classes.digraph.DiGraph:
    """
    ...
    topic_pub_dict: dict[str, list[str]] = {}   # "/topic_0": ["/node_0", ], <- publishers of /topic_0 are ["/node_0", ]
    topic_sub_dict: dict[str, list[str]] = {}   # "/topic_0": ["/node_1", ], <- subscribers of /topic_0 are ["/node_1", ]
    ...
    for topic, node_pub_list in topic_pub_dict.items():
        ...
        for node_pub in node_pub_list:
            for node_sub in node_sub_list:
                ...
                G.add_edge(node_pub, node_sub, label=quote_name(topic))
