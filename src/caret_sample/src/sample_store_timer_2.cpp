...
int main(int argc, char * argv[])
{
  ...
  node_list.emplace_back(std::make_shared<SampleNode::NodePub>("node_src", "/topic_src", 100));
  node_list.emplace_back(std::make_shared<SampleNode::NodeSubPub>("node_1", "/topic_src", "/topic_1"));
  node_list.emplace_back(std::make_shared<SampleNode::NodeSubStorePubTimer>("node_store", "/topic_1", "/topic_2", 10));
