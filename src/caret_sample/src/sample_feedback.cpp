...
int main(int argc, char * argv[])
{
  ...
  node_list.emplace_back(std::make_shared<SampleNode::NodeFeedbackFormer>("node_feedback_former", "/topic_src", "/topic_feedback", "/topic_1"));
  node_list.emplace_back(std::make_shared<SampleNode::NodeFeedbackLatter>("node_feedback_latter", "/topic_1", "/topic_2", "/topic_feedback"));
